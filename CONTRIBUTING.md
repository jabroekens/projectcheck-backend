...
De java code zal voldoen aan de stijling zoals geschreven in [Google Java Style Guide](https://google.github.io/styleguide/javaguide.html), met de volgende aanpassingen (dikgedrukt):
